...
if($_POST['typ']==1){
    ...
    if($id>=0)
        ...
        $sql = mysqli_query($con, "SELECT * FROM inzerat left join subor on(inzerat.id_inzerat = subor.inzerat_id_inzerat) where kategoria_id_kategoria is null 
                                          or  kategoria_id_kategoria='-1' order by inzerat.vytvorenie desc");
    $k = 0;
